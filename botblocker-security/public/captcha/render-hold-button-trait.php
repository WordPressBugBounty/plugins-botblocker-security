	...
	private function getHoldButtonData() {
		...
		return array(
			...
			'params' => array(
				...
				'instructionText' => self::t( 'Hold the button and release in the green zone' ),
				'buttonText'      => self::t( 'HOLD' ),
				'tooEarlyText'    => self::t( 'Too early. Try again.' ),
				'tooLateText'     => self::t( 'Too late. Try again.' ),
				'successText'     => self::t( 'Verifying...' ),
				'failText'        => self::t( 'Verification failed.' ),
				'maxAttempts'     => 3,
			),
		);
	}
