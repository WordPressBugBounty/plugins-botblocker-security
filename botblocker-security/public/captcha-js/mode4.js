...
function renderMode4Captcha(params) {
    const { confirmText, recaptchaKey, hash } = params;
    ...
    script.onload = function() {
        document.getElementById("content").innerHTML = `
            <div style="max-width: 302px; text-align: center;margin: 0 auto;">
                <p>${confirmText}</p>
                <p class="g-recaptcha" style="display: inline-block;" data-sitekey="${recaptchaKey}" data-callback="onRecaptchaSuccess">Loading...</p>
            </div>
        `;
    };
