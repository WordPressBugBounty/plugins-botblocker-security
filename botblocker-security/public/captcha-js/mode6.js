...
function renderMode6Captcha(params) {
    ...
    document.getElementById("content").innerHTML = `
        <div style="text-align:center;">
            <p>${instructionText}</p>
            <canvas id="mathCanvas" width="300" height="80" style="border:1px solid #ddd;"></canvas>
    ...
    (function() {
        ...
        answers.forEach(answer => {
            ...
            button.addEventListener("click", function() {
                window[bbcsJsData.checkFunctionName]('post', window.data, answer.hash);
            });
...
window.renderMode6Captcha = renderMode6Captcha;