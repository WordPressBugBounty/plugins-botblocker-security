			...
			<div class="row">
				<div class="col-md-6">
					<section class="card bbcs-fill-height">
						...
						<div class="card-body">
							<?php
								require_once BOTBLOCKER_DIR . 'includes/section/about/botblocker-about-contacts.php';
							?>
						</div>
					</section>
				</div>
				<div class="col-md-6">
					<section class="card bbcs-fill-height">
						...
						<div class="card-body">
							<?php
								require_once BOTBLOCKER_DIR . 'includes/section/about/botblocker-about-legal.php';
							?>
													</div>
					</section>
				</div>
			...
			<div class="row">
				<div class="col-md-12">
					<section class="card">
						...
						<div class="card-body">
							<?php
								require_once BOTBLOCKER_DIR . 'includes/section/about/botblocker-about-status.php';
							?>
						</div>
					</section>
				</div>
