        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-9 сol-lg-9 col-xl-9 col-xxl-10">
                ...
                <section class="card">
                    ...
                    <div class="card-body">						
					<?php
                        include_once BOTBLOCKER_DIR . 'includes/section/setup/botblocker-setup-health.php';
                        include_once BOTBLOCKER_DIR . 'includes/section/setup/botblocker-setup-pro.php';
                        include_once BOTBLOCKER_DIR . 'includes/section/setup/botblocker-setup-chain.php';
...
<?php
	include_once BOTBLOCKER_DIR . 'includes/modal/modal-botblocker-setup-wizard.php';
?>
