            ...
            <section class="card mb-2">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        ...
                        <?php  include_once BOTBLOCKER_DIR . 'includes/section/report/botblocker-report-dashboard.php'; ?>
...
<?php
	include_once BOTBLOCKER_DIR . 'includes/modal/modal-botblocker-hits-add-rule.php';
?>
