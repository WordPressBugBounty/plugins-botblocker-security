				...
				<section class="card">
					...
					<div class="card-body">						
						<ul class="nav nav-tabs">
							...
							<li class="nav-item">
								<a class="nav-link" data-bs-toggle="tab" href="#cookie"><?php esc_html_e( 'Cookie Settings', 'botblocker-security' ); ?></a>
							</li>						
							<li class="nav-item">
							...
							<li class="nav-item">
								<a class="nav-link" data-bs-toggle="tab" href="#rate_limiting"><?php esc_html_e( 'Rate Limiting', 'botblocker-security' ); ?></a>
							</li>
							<li class="nav-item">
							...
							<li class="nav-item">
								<a class="nav-link" data-bs-toggle="tab" href="#tls_fingerprint"><?php esc_html_e( 'TLS Fingerprinting', 'botblocker-security' ); ?></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-bs-toggle="tab" href="#settings-ui"><?php esc_html_e( 'UI Settings', 'botblocker-security' ); ?></a>
							</li>
							<li class="nav-item">
						...
						<div class="tab-content">
							<?php
								...
								require_once BOTBLOCKER_DIR . 'includes/section/settings/botblocker-set-rate-limiting.php';
								...
								require_once BOTBLOCKER_DIR . 'includes/section/settings/botblocker-set-tls.php';
