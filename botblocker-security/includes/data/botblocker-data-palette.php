 ...
 *
 * GROUPS are automatically derived from bbcs_get_global_search_index()
 ...
 */
function bbcs_get_palette_data(): array {
	$global_index = function_exists( 'bbcs_get_global_search_index' ) ? bbcs_get_global_search_index() : array();
	$auto_groups = array();
