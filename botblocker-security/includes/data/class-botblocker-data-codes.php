...
class BotBlockerDataCodes {

	/** @var array|null */
	private static $codes;

	public static function codeList( $code ): array {
		if ( self::$codes === null ) {
			self::$codes = array(
				0   => array(
				...
				5   => array(
					'msg'       => 'Good bot - verified IP or PTR record',
					'allow'     => true,
					'count'     => true,
					'searchbot' => true,
				),
				...
				7   => array(
					'msg'       => 'Fake bot - unverified IP or PTR record',
					'allow'     => false,
					'count'     => true,
					'searchbot' => false,
				),
				8   => array(
					'msg'       => 'Captcha verification failed - temporary ban applied',
					'allow'     => false,
					'count'     => true,
					'searchbot' => false,
				),
				...
				15  => array(
					'msg'       => 'Connection failure - VPN, Tor, or proxy detected',
					'allow'     => false,
					'count'     => true,
					'searchbot' => false,
				),
				...
				22  => array(
					'msg'       => 'Cloud API check failed (server or network error)',
					'allow'     => false,
					'count'     => true,
					'searchbot' => false,
				),
				...
				26  => array(
					'msg'       => 'Rate limit exceeded - brute force protection',
					'allow'     => false,
					'count'     => true,
					'searchbot' => false,
				),
				...
				30  => array(
					'msg'       => 'Early Init layer block',
					'allow'     => false,
					'count'     => true,
					'searchbot' => false,
				),
				40  => array(
					'msg'       => 'MU-plugin layer block',
					'allow'     => false,
					'count'     => true,
					'searchbot' => false,
				),
				...
				98  => array(
					'msg'       => 'BotBlocker activated by secret URL',
					'allow'     => true,
					'count'     => true,
					'searchbot' => false,
				),
				...
				429 => array(
					'msg'       => 'Rate limit block',
					'allow'     => false,
					'count'     => true,
					'searchbot' => false,
				),
				901 => array(
					'msg'       => 'Add-on traffic decision',
					'allow'     => false,
					'count'     => true,
					'searchbot' => false,
				),
		...
		$codes = apply_filters( 'bbcs_code_list', self::$codes );
