...
class BBCS_GoogleAuthenticator
{
    ...
    public function get_settings() {
        ...
        // Try to load settings from file first (generated by plugin into bbcs_data_dir()/settings.php)
        $file_settings = false;
        if ( function_exists('bbcs_data_dir') ) {
            $settings_file = rtrim(bbcs_data_dir(), DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . 'settings.php';
