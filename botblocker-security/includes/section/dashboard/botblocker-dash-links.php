...
?>
    <div class="col-lg-6">
        ...
        <section class="card">
            <?php $bbcs_is_cloud_api_active = ((function_exists('bbcs_isCloudAPIActive') && bbcs_isCloudAPIActive())); ?>
            <header class="card-header<?php echo $bbcs_is_cloud_api_active ? '' : ' bbcs-cloud-api-color-bg'; ?>">
                <div class="card-actions">
                    ...
                    <a href="<?php echo esc_url($BBCSA->pages_addons); ?>#bbcs-installed" class="bbcs-icon-button bbcs-card-action" data-bs-toggle="tooltip" data-bs-html="true" data-bs-placement="top" data-bs-original-title="Addons manager">
                        <i class="fa-solid fa-puzzle-piece<?php echo esc_attr($bbcs_iconColor); ?>"></i>
                    </a>
                </div>
                <h2 class="card-title<?php echo $bbcs_is_cloud_api_active ? '' : ' bbcs-color-white'; ?>"><?php esc_html_e('Addons', 'botblocker-security'); ?></h2>
            </header>
