	...
	<header class="card-header">
		<div class="card-actions">
			<a href="<?php echo esc_url( $BBCSA->pages_reports ); ?>#frontend" class="bbcs-icon-button bbcs-card-action" 
				...
				data-bs-original-title="<?php esc_attr_e( 'Website visitors report', 'botblocker-security' ); ?>">
		...
		<h2 class="card-title">
		<?php
		esc_html_e( 'Website Traffic', 'botblocker-security' );
		echo wp_kses_post( BotBlockerUI::is_realtime() );
		?>
		</h2>
		<p class="card-subtitle">
			<?php esc_html_e( 'Real-time visitor statistics. View period:', 'botblocker-security' ); ?><?php echo esc_html( $BBCS->settings->admin_report_period ); ?>
			<?php esc_html_e( 'days', 'botblocker-security' ); ?> 
			(<a href="<?php echo esc_url( $BBCSA->pages_settings ); ?>#settings-ui"><?php esc_html_e( 'Change', 'botblocker-security' ); ?></a>).</p>
	</header>
	<div class="card-body">
		<div class="row">
			<div class="col-lg-8">
