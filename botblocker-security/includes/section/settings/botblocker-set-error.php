...
<div class="tab-pane container fade" id ="error"> 
	<div class="row">
		...
		<div class="col-xxl-3 col-xl-6 col-lg-6 col-sm-12 col-md-12">
			...
			<?php
			$bbcs_available_directives = bbcs_get_x_robot_tags();
			...
			$bbcs_selected_directives = isset($bbcs_settings['x_robots_directives']) ? 
    			...
    			json_decode($bbcs_settings['x_robots_directives'], true)) : [];

			if (!is_array($bbcs_selected_directives)) {
    			$bbcs_selected_directives = [];
			}
			...
			<div class="bbcs_checkbox_input mb-2">
				...
				<i class="fa-regular fa-circle-question"
					...
					data-bs-original-title="<?php echo sprintf(esc_html__('Enable %s directive in X-Robots-Tag headers', 'botblocker-security'), esc_html($bbcs_directive_display)); ?>">
				</i>
			</div>
			<?php } ?>
		</div>
