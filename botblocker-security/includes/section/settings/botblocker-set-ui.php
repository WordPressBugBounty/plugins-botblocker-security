			...
			<div class="bbcs_text_input mb-2">
    			...
    			<div class="bbcs_text_input_inner">
        			<select class="bbcs_select_input_input" name="admin_gmt_offset">
            			<?php
            			$bbcs_gmt_offsets = [-12, -11, -10, -9.5, -9, -8, -7, -6, -5, -4, -3.5, -3, -2, -1, 0, 1, 2, 3, 3.5, 4, 4.5, 5, 5.5, 5.75, 6, 6.5, 7, 8, 8.75, 9, 9.5, 10, 10.5, 11, 12, 13, 14];
            			...
            			foreach ($bbcs_gmt_offsets as $bbcs_offset) {
							...
							echo '<option value="' . esc_attr($bbcs_offset) . '" ' . esc_html($bbcs_selected) . '>' . esc_html($bbcs_label) . '</option>';
            			}
            			?>
        			</select>
    			</div>
