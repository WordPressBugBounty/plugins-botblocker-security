...
if (empty($bbcs_secret)) {
    $bbcs_secret = $bbcs_google_auth->createSecret();
    update_user_meta($bbcs_user_id, '_2fa_secret_temp', $bbcs_secret);
}

$bbcs_backup_codes = get_user_meta($bbcs_user_id, '_2fa_backup_codes_temp', true);
if (empty($bbcs_backup_codes)) {
    $bbcs_backup_codes = bbcs_generate_backup_codes();
    update_user_meta($bbcs_user_id, '_2fa_backup_codes_temp', $bbcs_backup_codes);
}
...
?><div class="tab-pane container fade" id="bbcs_2fa">
    <div class="row">
            ...
            <div class="bbcs_checkbox_input mt-3 mb-3">
                <div class="bbcs_label_checkbox_box">
                    <input type="checkbox"
                        ...
                        value="1"
                        <?php checked(1, isset($bbcs_settings['bbcs_2fa_enable']) ? $bbcs_settings['bbcs_2fa_enable'] : 1);
                        ?>>
            ...
            <div class="bbcs-2fa-verified" <?php echo ($bbcs_2fa_verified) ? ' style="display: none;"' : ''; ?>>
                ...
                <div class="bbcs_checkbox_input mb-2">
                    <div class="d-flex justify-content-center w-100 mb-3">
                        <img src="<?php echo esc_url($bbcs_qr_url); ?>"
                            alt="QR Code"
                            id="bbcs_2fa_qr-code"
        ...
        <div class="col-xxl-3 col-xl-6 col-lg-6 col-sm-12 col-md-12">
            ...
            <?php if (isset($bbcs_roles) && is_array($bbcs_roles) && count($bbcs_roles) > 0) {
                    ...
                    <div class="bbcs_checkbox_input mt-3 mb-3">
                        <div class="bbcs_label_checkbox_box">
                            <input type="checkbox"
                                ...
                                value="1"
                                <?php checked(1, isset($bbcs_settings['bbcs_2fa_roles'][$bbcs_role_key]) ? $bbcs_settings['bbcs_2fa_roles'][$bbcs_role_key] : 0);
                                ?>>
