...
?><div class="tab-pane fade" id="bbcs_redis">
    <div class="row">
        ...
        <div class="col-xxl-3 col-xl-6 col-lg-6 col-sm-12 col-md-12">
            ...
            <div class="bbcs_text_input mb-2">
                <div class="bbcs_label_input_box">
                    <span class="bbcs-label-input"><?php esc_html_e('Redis Database Number:', 'botblocker-security'); ?></span>
                    <i class="fa-regular fa-circle-question" data-bs-toggle="tooltip" data-bs-html="true" data-bs-placement="top"
                        data-bs-original-title="<?php esc_attr_e('Select Redis database number (0-15). Different databases provide logical separation of data within the same Redis instance.', 'botblocker-security'); ?>"></i>
                </div>
                <div class="bbcs_text_input_inner">
                    <input type="number" class="bbcs_number_input_input" name="redis_db" value="<?php echo isset($bbcs_settings['redis_db']) ? esc_html($bbcs_settings['redis_db']) : 0; ?>">
                </div>
            </div>
        </div>
    </div>
