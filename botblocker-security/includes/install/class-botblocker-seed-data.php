	...
	public static function insertDefaultSearchEngines(): void {
		...
		$default_search_engines = array(
			...
			array(
				...
				'data'     => '.google.com',
				'rule'     => 'allow',
				'comment'  => 'PageSpeed Insights',
				'disable'  => 0,
			),
			array(
				'priority' => 1,
				'search'   => 'Mediapartners',
				'data'     => '.googlebot.com .google.com',
				'rule'     => 'allow',
				'comment'  => 'AdSense bot',
				'disable'  => 0,
			),
			array(
				'priority' => 2,
				'search'   => 'Googlebot-Image',
				'data'     => '.googlebot.com .google.com',
				'rule'     => 'allow',
				'comment'  => 'Google Images',
				'disable'  => 0,
			),
			array(
				'priority' => 2,
				'search'   => 'Googlebot-Video',
				'data'     => '.googlebot.com .google.com',
				'rule'     => 'allow',
				'comment'  => 'Google Videos',
				'disable'  => 0,
			),
			array(
				'priority' => 2,
				'search'   => 'Googlebot-News',
				'data'     => '.googlebot.com .google.com',
				'rule'     => 'allow',
				'comment'  => 'Google News',
				'disable'  => 0,
			...
			array(
				'priority' => 2,
				'search'   => 'Storebot-Google',
				'data'     => '.google.com',
				'rule'     => 'allow',
				'comment'  => 'Google Shopping',
				'disable'  => 0,
			),
			array(
				'priority' => 5,
				'search'   => 'GoogleOther-Image',
				'data'     => '.google.com',
				'rule'     => 'allow',
				'comment'  => 'GoogleOther Images',
				'disable'  => 0,
			),
			array(
				'priority' => 5,
				'search'   => 'GoogleOther-Video',
				'data'     => '.google.com',
				'rule'     => 'allow',
				'comment'  => 'GoogleOther Videos',
				'disable'  => 0,
			),
			array(
				'priority' => 5,
			...
			array(
				'priority' => 10,
				'search'   => 'Googlebot',
				'data'     => '.googlebot.com asn:15169',
				'rule'     => 'allow',
				'comment'  => 'GoogleBot (Catch-all)',
				'disable'  => 0,
			),
			array(
				'priority' => 10,
			...
			array(
				...
				'data'     => 'search.msn.com',
				'rule'     => 'allow',
				'comment'  => 'Microsoft Bing search bot',
				'disable'  => 0,
			),
			array(
				'priority' => 2,
			...
			array(
				'priority' => 3,
				'search'   => 'yandex.com',
				'data'     => '.yandex.ru .yandex.net .yandex.com asn:13238 ip:45.138.0.0/24 ip:45.148.65.0/24 ip:141.8.183.0/24',
				'rule'     => 'allow',
				'comment'  => 'Yandex search bots and services',
				'disable'  => 0,
			),
			array(
				'priority' => 4,
				'search'   => 'Applebot',
				'data'     => '.applebot.apple.com',
				'rule'     => 'allow',
				'comment'  => 'Applebot crawler',
				'disable'  => 0,
			),
			array(
				'priority' => 5,
				...
				'data'     => '.googlebot.com .google.com',
				'rule'     => 'allow',
				'comment'  => 'Verification bot for Google Search Console',
				'disable'  => 0,
			),
			array(
				'priority' => 6,
				...
				'data'     => '.duckduckgo.com',
				'rule'     => 'allow',
				'comment'  => 'DuckDuckGo search engine bot',
				'disable'  => 0,
			),
			array(
				'priority' => 8,
				'search'   => 'PetalBot',
				'data'     => '.petalsearch.com .aspiegel.com',
				'rule'     => 'allow',
				'comment'  => 'Huawei Petal Search',
				'disable'  => 0,
			),
			array(
				'priority' => 12,
				...
				'data'     => '.seznam.cz',
				'rule'     => 'allow',
				'comment'  => 'Seznam.cz search engine bot',
				'disable'  => 0,
			),
			array(
				'priority' => 15,
				...
				'data'     => '.naver.com',
				'rule'     => 'allow',
				'comment'  => 'Naver search engine bot',
				'disable'  => 0,
			),
			array(
				'priority' => 16,
				...
				'data'     => '.sogou.com',
				'rule'     => 'allow',
				'comment'  => 'Sogou search engine bot',
				'disable'  => 0,
			),
			array(
				'priority' => 18,
				...
				'data'     => '.baidu.com',
				'rule'     => 'allow',
				'comment'  => 'Baidu search engine bot (China)',
				'disable'  => 0,
			),
			array(
				'priority' => 20,
				...
				'data'     => '.mojeek.com',
				'rule'     => 'allow',
				'comment'  => 'Mojeek search engine bot',
				'disable'  => 0,
			),
			array(
				'priority' => 22,
			...
			array(
				...
				'data'     => 'search.msn.com',
				'rule'     => 'allow',
				'comment'  => 'Legacy Microsoft search bot',
				'disable'  => 0,
			),
			array(
				'priority' => 11,
			...
			array(
				'priority' => 19,
				'search'   => 'vkShare',
				'data'     => '.vk.com .vkontakte.ru .userapi.ru',
				'rule'     => 'allow',
				'comment'  => 'VK link preview',
				'disable'  => 0,
			),
			array(
				'priority' => 24,
				'search'   => 'LinkedInBot',
				'data'     => '.linkedin.com .ads.linkedin.com',
				'rule'     => 'allow',
				'comment'  => 'LinkedIn bot for link preview and ads',
				'disable'  => 0,
			),
			array(
				'priority' => 26,
				...
				'data'     => '.pinterest.com',
				'rule'     => 'allow',
				'comment'  => 'Pinterest link preview bot',
				'disable'  => 0,
			),
			array(
				'priority' => 25,
			...
			array(
				'priority' => 45,
				'search'   => 'Discordbot',
				'data'     => '.discordapp.com .discord.com',
				'rule'     => 'allow',
				'comment'  => 'Discord link expander',
				'disable'  => 0,
			),
			array(
				'priority' => 48,
				'search'   => 'OdklBot',
				'data'     => '.odnoklassniki.ru',
				'rule'     => 'allow',
				'comment'  => 'Odnoklassniki link preview',
				'disable'  => 0,
			),
			array(
				'priority' => 49,
			...
			array(
				'priority' => 60,
				'search'   => 'UptimeRobot',
				'data'     => 'uptimerobot.com',
				'rule'     => 'allow',
				'comment'  => 'UptimeRobot monitoring',
				'disable'  => 0,
			),
			array(
				'priority' => 60,
			...
			array(
				'priority' => 60,
				'search'   => 'BetterUptime',
				'data'     => 'betteruptime.com',
				'rule'     => 'allow',
				'comment'  => 'Better Uptime monitoring',
				'disable'  => 0,
			),
			array(
				'priority' => 70,
				...
				'rule'     => 'allow',
				'comment'  => 'Facebook tracking and analytics',
				'disable'  => 0,
			),
			array(
				'priority' => 70,
				...
				'data'     => '.hotjar.com',
				'rule'     => 'allow',
				'comment'  => 'Hotjar analytics service',
				'disable'  => 0,
			),
			array(
				'priority' => 70,
				...
				'data'     => '.quantserve.com',
				'rule'     => 'gray',
				'comment'  => 'Quantcast analytics and audience measurement',
				'disable'  => 0,
			),
			array(
				'priority' => 70,
				'search'   => 'Heap Analytics',
				'data'     => '.heap.io',
				'rule'     => 'allow',
				'comment'  => 'Heap analytics service',
				'disable'  => 0,
			),
			array(
				'priority' => 70,
				...
				'data'     => '.matomo.org',
				'rule'     => 'allow',
				'comment'  => 'Matomo (formerly Piwik) analytics bot',
				'disable'  => 0,
			),
			array(
				'priority' => 70,
				...
				'data'     => '.mixpanel.com',
				'rule'     => 'allow',
				'comment'  => 'Mixpanel analytics and tracking service',
				'disable'  => 0,
			),
			array(
				'priority' => 70,
			...
			array(
				'priority' => 70,
				'search'   => 'Snapchat Pixel',
				'data'     => '.snapchat.com .pixel.snapchat.com',
				'rule'     => 'allow',
				'comment'  => 'Snapchat tracking pixel bot',
				'disable'  => 0,
			),
			array(
				'priority' => 80,
				...
				'data'     => '.ahrefs.com',
				'rule'     => 'dark',
				'comment'  => 'Ahrefs SEO and crawling bot',
				'disable'  => 0,
			),
			array(
				'priority' => 80,
				...
				'data'     => '.semrush.com',
				'rule'     => 'dark',
				'comment'  => 'Semrush SEO crawler',
				'disable'  => 0,
			),
			array(
				'priority' => 80,
				'search'   => 'MJ12bot',
				'data'     => '.majestic12.co.uk .mj12bot.com',
				'rule'     => 'dark',
				'comment'  => 'Majestic crawler',
				'disable'  => 0,
			),
			array(
				'priority' => 80,
	...
	public static function insertDefaultPaths(): void {
		...
		$default_paths = array(
			array(
				...
				'search'   => '/wp-cron.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress cron jobs',
				'disable'  => 1,
			),
			array(
				'priority' => 1,
				'search'   => '/wp-admin/admin-ajax.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress AJAX',
				'disable'  => 1,
			),
			array(
				'priority' => 1,
				'search'   => '/wp-admin/post.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress POST',
				'disable'  => 1,
			),
			array(
				'priority' => 1,
	...
	public static function insertExtendedPaths(): void {
		...
		$default_paths = array(
			...
			array(
				...
				'rule'     => 'allow',
				'comment'  => 'WordPress script loading',
				'disable'  => 0,
			),
			array(
				'priority' => 1,
				...
				'rule'     => 'allow',
				'comment'  => 'WordPress style loading',
				'disable'  => 0,
			),
			array(
				'priority' => 10,
				'search'   => '/wp-admin/admin-post.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress admin posts',
				'disable'  => 0,
			),
			array(
				'priority' => 1,
				'search'   => '/wp-admin/async-upload.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress async upload',
				'disable'  => 0,
			),
			array(
				'priority' => 1,
				'search'   => '/wp-admin/update-core.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress core updates',
				'disable'  => 0,
			),
			array(
				'priority' => 10,
				'search'   => '/wp-admin/customize.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress customizer',
				'disable'  => 0,
			),
			array(
				'priority' => 10,
				...
				'rule'     => 'allow',
				'comment'  => 'WordPress admin',
				'disable'  => 0,
			),
			array(
				'priority' => 10,
				'search'   => '/wp-admin/options.php',
				'rule'     => 'allow',
			...
			array(
				'priority' => 10,
				'search'   => '/wp-admin/edit-comments.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress comment editing',
				'disable'  => 0,
			),
			array(
				'priority' => 10,
				'search'   => '/wp-admin/edit.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress post/page editing',
				'disable'  => 0,
			),
			array(
				'priority' => 10,
				'search'   => '/wp-admin/users.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress user management',
				'disable'  => 0,
			),
			array(
				'priority' => 10,
				'search'   => '/wp-admin/profile.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress user profile',
				'disable'  => 0,
			),
			array(
				'priority' => 10,
				'search'   => '/wp-admin/media-new.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress media upload',
				'disable'  => 0,
			),
			array(
				'priority' => 10,
				'search'   => '/wp-admin/upload.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress media library',
				'disable'  => 0,
			),
			array(
				'priority' => 10,
				'search'   => '/wp-admin/post-new.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress new post/page',
				'disable'  => 0,
			),
			array(
				'priority' => 10,
				'search'   => '/wp-admin/edit-tags.php',
				'rule'     => 'allow',
				'comment'  => 'WordPress taxonomy management',
				'disable'  => 0,
			),
			array(
				'priority' => 10,
				...
				'rule'     => 'allow',
				'comment'  => 'WordPress comment posting',
				'disable'  => 0,
			),
			array(
				'priority' => 10,
				'search'   => '/wp-includes/js/tinymce/',
				'rule'     => 'allow',
				'comment'  => 'WordPress TinyMCE editor',
				'disable'  => 0,
			),
			array(
				'priority' => 1,
