...
function bbcs_get_botblocker_news($atts)
{
    ...
    if (is_wp_error($rss)) {
        return 'Error fetching news: ' . $rss->get_error_message();
    }
...
function bbcs_getDatabaseUpdate() {
...
function bbcs_plugins_themes_view() {
