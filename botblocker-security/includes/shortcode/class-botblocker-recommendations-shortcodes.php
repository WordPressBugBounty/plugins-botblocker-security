...
class BotBlockerRecommendationsShortcodes {

	public static function register(): void {
		add_shortcode( 'bbcs_recommendations', array( self::class, 'renderRecommendations' ) );
	}

	public static function renderRecommendations(): string {
