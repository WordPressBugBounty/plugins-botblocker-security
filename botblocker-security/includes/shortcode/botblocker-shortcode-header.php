...
function bbcs_extract_locale_from_mo($path, $text_domain = 'botblocker-security') {
...
function bbcs_get_lang_options_html() {
...
<?php   }
       ...
       // error_log('BotBlocker ERROR: Missing ".mo" files in "languages" directory, line[' . __LINE__. '], File: ' . __FILE__ . ']');
?>          <li>
