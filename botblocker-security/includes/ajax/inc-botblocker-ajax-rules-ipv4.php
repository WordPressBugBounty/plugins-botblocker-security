...
function bbcs_delete_ipv4_rule_callback()
{
    ...
    if ($result !== false) {
        ...
        wp_send_json_success(__('IPv4 rule deleted successfully.', 'botblocker-security'));
    } else {
        wp_send_json_error(__('Failed to delete IPv4 rule.', 'botblocker-security'));
    }
}
...
function bbcs_toggle_ipv4_rule_callback() {
    ...
    wp_send_json_success( __('IPv4 rule toggled successfully.', 'botblocker-security') );
}
...
function bbcs_create_ipv4_rule_callback()
{
    ...
    if ($result !== false) {
        ...
        wp_send_json_success(__('IPv4 rule created successfully.', 'botblocker-security'));
    } else {
        wp_send_json_error(__('Failed to create IPv4 rule.', 'botblocker-security'));
    }
}
...
function bbcs_update_ipv4_rule_callback()
{
    ...
    if ($result !== false) {
        ...
        wp_send_json_success(__('IPv4 rule updated successfully.', 'botblocker-security'));
    } else {
        wp_send_json_error(__('Failed to update IPv4 rule.', 'botblocker-security'));
    }
}
...
function bbcs_clear_all_ipv4_rules_callback()
{
    ...
    if ($result !== false) {
        ...
        wp_send_json_success(__('All IPv4 rules have been cleared.', 'botblocker-security'));
    } else {
        wp_send_json_error(__('Failed to clear IPv4 rules.', 'botblocker-security'));
    }
}
...
function bbcs_ipv4_to_php_callback(): void
{
    ...
    try {
        ...
        wp_send_json_success(__('IPv4 rules file generated successfully.', 'botblocker-security'));
    } catch(\Throwable $e) {
        // error_log('ipv6_to_php_callback error: ' . $e->getMessage());
        wp_send_json_error(__('Failed to generate IPv4 rules file from database.', 'botblocker-security'));
    }
}
