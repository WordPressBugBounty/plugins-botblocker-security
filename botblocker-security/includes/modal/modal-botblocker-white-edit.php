...
?><div class="modal fade" id="editWhiteModal" tabindex="-1" aria-labelledby="editWhiteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editWhiteModalLabel"><?php esc_html_e('Edit White Bot', 'botblocker-security'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="editWhiteForm">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="editWhiteForm" class="btn btn-primary btn-xs"><?php esc_html_e('Save changes', 'botblocker-security'); ?></button>
            </div>
        </div>
    </div>
</div>
