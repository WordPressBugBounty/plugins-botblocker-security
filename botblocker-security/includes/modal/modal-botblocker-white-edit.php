	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="editWhiteModalLabel"><?php esc_html_e( 'Edit Trusted Bot', 'botblocker-security' ); ?></h5>
			...
			<div class="modal-footer">
				...
				<button type="submit" form="editWhiteForm" class="btn btn-primary btn-xs"><?php esc_html_e( 'Save', 'botblocker-security' ); ?></button>
			</div>
		</div>
	</div>
</div>
