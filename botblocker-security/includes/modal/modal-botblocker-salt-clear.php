...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="confirmSaltClearModalLabel"><?php esc_html_e('Confirmation of Salt clearing', 'botblocker-security'); ?></h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <p class="bbcs-black"><strong><?php esc_html_e('Attention!', 'botblocker-security'); ?></strong> <?php esc_html_e('Updating the Salt file will reset all visitors\' authentication cookies:', 'botblocker-security'); ?></p>
            <ul class="bbcs-black bbcs-modal-ul">
                ...
                <li class="bbcs-modal-li"><?php esc_html_e('All visitors will have to re-authenticate.', 'botblocker-security'); ?></li>
                <li class="bbcs-modal-li"><?php esc_html_e('The changes will take effect immediately.', 'botblocker-security'); ?></li>
