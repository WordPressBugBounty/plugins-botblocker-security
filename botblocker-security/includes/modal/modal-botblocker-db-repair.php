...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p class="bbcs-black"><strong><?php esc_html_e('To enable the database repair and optimization feature:', 'botblocker-security'); ?></strong></p>
            <ol>
                ...
                <li><?php esc_html_e('After the repair is completed,', 'botblocker-security'); ?> <strong><?php esc_html_e('delete', 'botblocker-security'); ?></strong> <?php esc_html_e('the added line from wp-config.php for security purposes.', 'botblocker-security'); ?></li>
            </ol>
            <div class="alert alert-warning">
                <strong><?php esc_html_e('Attention!', 'botblocker-security'); ?></strong> <?php esc_html_e('The database repair page is accessible to everyone without authentication when the option is enabled. Don’t forget to disable it after use!', 'botblocker-security'); ?>
            </div>
        </div>
