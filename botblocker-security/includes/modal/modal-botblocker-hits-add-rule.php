...
?><div class="modal fade" id="AddRuleModal" tabindex="-1" aria-labelledby="createRuleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="AddRuleModalLabel"><?php esc_html_e('Add Rule', 'botblocker-security'); ?></h5>
                        ...
                        <div class="col-md-6">
                            <div class="bbcs_text_input">
                                <div class="bbcs_label_input_box">
                                    ...
                                    <i class="fa-regular fa-circle-question" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="<?php esc_attr_e('Select the type of rule to apply', 'botblocker-security'); ?>"></i>
                                </div>
                                <div class="bbcs_text_input_inner">
                                    <select class="bbcs_select_input_input" id="type" name="type" required>
                                        <option value="ip" selected><?php esc_html_e('IP', 'botblocker-security'); ?></option>
                                        <option value="useragent"><?php esc_html_e('User Agent', 'botblocker-security'); ?></option>
                        ...
                        <div class="col-md-6">
                            <div class="bbcs_text_input">
                                <div class="bbcs_label_input_box">
                                    ...
                                    <i class="fa-regular fa-circle-question" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="<?php esc_attr_e('Set the priority of the rule (1-100)', 'botblocker-security'); ?>"></i>
                                </div>
                                <div class="bbcs_text_input_inner">
                        ...
                        <div class="col-md-6">
                            <div class="bbcs_text_input">
                                <div class="bbcs_label_input_box">
                                    ...
                                    <i class="fa-regular fa-circle-question" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="<?php esc_attr_e('Your selected data for the rule', 'botblocker-security'); ?>"></i>
                                </div>
                                <div class="bbcs_text_input_inner">
                                    <input type="text" name="ip" id="this_ip" hidden>
                        ...
                        <div class="col-md-6">
                            <div class="bbcs_text_input">
                                <div class="bbcs_label_input_box">
                                    ...
                                    <i class="fa-regular fa-circle-question" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="<?php esc_attr_e('Add a comment for this rule', 'botblocker-security'); ?>"></i>
                                </div>
                                <div class="bbcs_text_input_inner">
                        ...
                        <div class="col-md-6">
                            <div class="bbcs_text_input">
                                <div class="bbcs_label_input_box">
                                    ...
                                    <i class="fa-regular fa-circle-question" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="<?php esc_attr_e('Select the action for this rule', 'botblocker-security'); ?>"></i>
                                </div>
                                <div class="bbcs_text_input_inner">
                        ...
                        <div class="col-md-6">
                            <div class="bbcs_text_input">
                                <div class="bbcs_label_input_box">
                                    ...
                                    <i class="fa-regular fa-circle-question" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="<?php esc_attr_e('Set the expiration date and time for this rule', 'botblocker-security'); ?>"></i>
                                </div>
                                <div class="bbcs_text_input_inner">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="addRuleForm" class="btn btn-primary btn-xs"><?php esc_html_e('Add rule', 'botblocker-security'); ?></button>
            </div>
        </div>
    </div>
</div>
