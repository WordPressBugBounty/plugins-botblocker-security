                            ...
                            <div class="bbcs_text_input">
                                ...
                                <div class="bbcs_text_input_inner">
                                    <select class="bbcs_select_input_input" id="type" name="type" required>
                                        ...
                                        <option value="httpaccept"><?php esc_html_e('HTTP Accept', 'botblocker-security'); ?></option>
                                        ...
                                        <option value="scriptname"><?php esc_html_e('Script Name', 'botblocker-security'); ?></option>
                                        <option value="ym_uid"><?php esc_html_e('Yandex.Metrica ID', 'botblocker-security'); ?></option>
                                        <option value="ga_uid"><?php esc_html_e('Google Analytics ID', 'botblocker-security'); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="bbcs_text_input">
                                <div class="bbcs_label_input_box">
                                    ...
                                    <i class="fa-regular fa-circle-question" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="<?php esc_attr_e('Enter the data for the rule', 'botblocker-security'); ?>"></i>
                                </div>
                                <div class="bbcs_text_input_inner">
