...
$bbcs_can_full = (function_exists('bbcs_isCloudAPIActive') && bbcs_isCloudAPIActive());
$bbcs_connect_url = isset($BBCSA) && !empty($BBCSA->pages_cloud_api ?? '') ? esc_url($BBCSA->pages_cloud_api) : 'https://botblocker.top/pricing/';
?>
<div class="modal fade" id="bbcsOneClickSetupModal" tabindex="-1" aria-labelledby="bbcsOneClickSetupLabel" aria-hidden="true" data-pro="<?php echo function_exists('bbcs_isCloudAPIActive') && bbcs_isCloudAPIActive() ? '1' : '0'; ?>">
