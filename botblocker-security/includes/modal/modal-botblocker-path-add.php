	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="createPathModalLabel"><?php esc_html_e( 'Add Path Rule', 'botblocker-security' ); ?></h5>
			...
			<div class="modal-footer">
				...
				<button type="submit" form="createPathForm" class="btn btn-primary btn-xs"><?php esc_html_e( 'Add', 'botblocker-security' ); ?></button>
			</div>
		</div>
	</div>
</div>
